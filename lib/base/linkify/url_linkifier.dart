...
/// This linkifier fixes the fact that the one in the library requires 2/3 character ending subdomain like .co or .com.
final _urlRegex = RegExp(
  r'^(.*?)((?:https?:\/\/|www\.)[^\s/$.?#].[^\s]*)',
  caseSensitive: false,
  dotAll: true,
);
/// This url regex will not require .com or .co. It allows for unlimited sub domain.
