...
String _$notificationsWithStatusHash() =>
    r'915e9f7947636b29ea702057e3b40f37bd723f1b';

/// See also [notificationsWithStatus].
@ProviderFor(notificationsWithStatus)
final notificationsWithStatusProvider = FutureProvider<
...
typedef NotificationsWithStatusRef
    = FutureProviderRef<List<({NotificationModel notification, bool unread})>>;
